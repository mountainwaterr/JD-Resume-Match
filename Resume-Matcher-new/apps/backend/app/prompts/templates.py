...
IMPORTANT: The resume content is in {output_language}. Preserve ALL text in {output_language} — do NOT translate names, titles, descriptions, or skills to another language.
...
IMPORTANT: The job description is in {output_language}. Extract keywords, responsibilities, and all text values in {output_language} — do NOT translate.
