...
async def extract_job_keywords(job_description: str, language: str = "en") -> dict[str, Any]:
    """Extract keywords and requirements from job description.

    Args:
        job_description: Raw job description text
        language: ISO language code for output (zh/en/ja/es/pt)
    ...
    output_language = get_language_name(language)
    sanitized_jd = _sanitize_user_input(job_description)
    prompt = EXTRACT_KEYWORDS_PROMPT.format(job_description=sanitized_jd, output_language=output_language)
