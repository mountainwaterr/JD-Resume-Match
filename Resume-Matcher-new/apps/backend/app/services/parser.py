...
from app.prompts.templates import RESUME_SCHEMA_EXAMPLE, get_language_name
...
async def parse_resume_to_json(markdown_text: str, language: str = "en") -> dict[str, Any]:
    ...
    Args:
        ...
        language: ISO language code detected from resume (zh/en/ja/es/pt)
