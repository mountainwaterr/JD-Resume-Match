  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div
          className="relative w-full max-w-md border border-border-soft bg-white shadow-lg rounded-lg p-6"
        ...
        >
          ...
          {/* Title */}
          <h3 className="font-sans text-sm font-medium mb-4 text-foreground">
