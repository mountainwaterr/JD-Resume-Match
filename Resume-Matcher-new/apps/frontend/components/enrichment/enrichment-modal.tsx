  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center p-5 sm:p-10">
        <div className="relative w-full h-full max-w-[1200px] bg-white border-2 border-border-soft shadow-xl flex flex-col overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b-2 border-border-soft bg-paper-tint">
            <div className="flex items-center gap-3">
              <Sparkles className="w-5 h-5" />
              <h1 className="font-mono text-lg font-bold uppercase tracking-wider">{'简历增强'}</h1>
            </div>
