...
The most important setting is your AI provider. Here's a minimal configuration for DeepSeek (default):
...
|----------|--------------|-------------|
| **DeepSeek** (default) | `LLM_PROVIDER=deepseek`<br>`LLM_MODEL=deepseek-chat` | [platform.deepseek.com](https://platform.deepseek.com/) |
...
| `LLM_PROVIDER` | `deepseek` | AI provider (deepseek, openai, anthropic, gemini, etc.) |
