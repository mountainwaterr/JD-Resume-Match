    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex flex-col items-center justify-center p-8 bg-background">
          <div className="max-w-md w-full bg-white border border-border-soft shadow-md p-8">
            ...
            <div className="flex gap-3">
              <Button
                ...
                variant="outline"
                className="flex-1 border-border-soft rounded-lg shadow-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all"
              >
                {strings.tryAgain}
              </Button>
              <Button
                onClick={this.handleReload}
                className="flex-1 bg-primary hover:bg-primary/90 text-white rounded-lg border border-border-soft shadow-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all"
              >
