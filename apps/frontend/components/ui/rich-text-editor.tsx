  ...
  if (!isMounted) {
    return (
      <div className={cn('space-y-1', className)}>
        <div className="flex items-center gap-1 p-1 border border-border-soft bg-muted h-9 rounded-t-lg" />
        <div
          className={cn(
            'w-full border border-border-soft bg-white',
            'px-3 py-2 text-sm text-muted-foreground rounded-b-lg'
          )}
          style={{ minHeight }}
        >
          {placeholder}
  ...
  return (
    <div className={cn('space-y-1', className)}>
      ...
      <div
        className={cn(
          'w-full border border-border-soft bg-white',
          'px-3 py-2 text-sm text-foreground rounded-b-lg',
