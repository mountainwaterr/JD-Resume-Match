...
class AnswerInput(BaseModel):
    ...
    item_id: str | None = Field(default=None, max_length=50)
...
class ApplyEnhancementsRequest(BaseModel):
    ...
    enhancements: list[EnhancedDescription] = Field(min_length=1, max_length=50)
...
class RegenerateRequest(BaseModel):
    ...
    resume_id: str = Field(min_length=1, max_length=50)
    items: list[RegenerateItemInput] = Field(min_length=1, max_length=20)
